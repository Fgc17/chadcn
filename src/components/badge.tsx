  ...
  "inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline",
  {
    variants: {
      variant: {
        ...
        plain: "text-gray-950 dark:text-gray-50 bg-transparent border-1",
        ...
        green:
          "bg-green-500/15 text-green-700 group-data-[hover]:bg-green-500/25 dark:bg-green-500/10 dark:text-green-400 dark:group-data-[hover]:bg-green-500/20 border-green-500",
        emerald:
